...
.. proof:proof::
    ...
    这要求 :math:`C \subset A \cap (\mathcal{C} B \cup C)`. :math:`C \subset \mathcal{C} B \cup C` 是显然的，故上式等价于 :math:`C \subset A`.
...
.. proof:solution::
    ...
    .. note::
        ...
        .. math::
            ...
            s: \mathbb{N} \times \mathbb{N} \to \mathbb{N}, \quad (m, n) \mapsto \dfrac{(m + n - 2)(m + n - 1)}{2} + m.
