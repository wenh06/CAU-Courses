...
# -- Options for TikZ -------------------------------------------------
tikz_extra_packages = "[slantfont,boldfont]xeCJK, amsfonts, amssymb, amssymb, mathrsfs, pifont, relsize"
...
def setup(app):
    ...
    app.add_js_file("js/render_pdf.js", **{"type": "module"})
